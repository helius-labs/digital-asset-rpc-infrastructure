use crate::{
    ...
    program_transformers::bubblegum::{
        ...
        upsert_asset_with_seq, upsert_creators_info_in_asset,
    },
    ...
    T: ConnectionTrait + TransactionTrait,
{
    if let (
        ...
        let uri = if let Some(uri) = &update_args.uri {
            ...
            current_metadata.uri.trim().replace('\0', "")
        };
        ...
        upsert_creators_info_in_asset(&multi_txn, id_bytes.to_vec(), creators, slot_i, seq as i64)
            .await?;
