...
pub struct IngesterConfig {
    ...
    pub ipfs_gateway_token: Option<String>,
    pub arweave_gateway: Option<String>,
    pub bg_task_config: Option<BgTaskConfig>,
    pub price_update_interval_seconds: Option<u64>,
    pub pod_type: Option<PodType>,
    pub skip_offchain: Option<bool>,
...
impl Display for IngesterRole {
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            IngesterRole::BackgroundTaskManager => write!(f, "BackgroundTaskManager"),
...
pub fn setup_ingester_config() -> IngesterConfig {
    let mut config: IngesterConfig = load_config_using_env_prefix("INGESTER_");
