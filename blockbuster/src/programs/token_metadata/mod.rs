...
pub struct TokenExtensionsMetadataParser;

trait CommonMetadataParser {
    #[allow(unused)]
    fn key(&self) -> Pubkey {
        token_metadata_id()
    }
...
impl CommonMetadataParser for TokenMetadataParser {}

impl CommonMetadataParser for TokenExtensionsMetadataParser {}
...
impl ProgramParser for TokenMetadataParser {
    ...
    fn handle_account(
        ...
        CommonMetadataParser::handle_account(self, account_info)
    }

    fn handles_account_updates(&self) -> bool {
        CommonMetadataParser::handles_account_updates(self)
    }

    fn handles_instructions(&self) -> bool {
        CommonMetadataParser::handles_instructions(self)
    }
}

impl ProgramParser for TokenExtensionsMetadataParser {
    fn key(&self) -> Pubkey {
        token_extensions_metadata_id()
    }

    fn key_match(&self, key: &Pubkey) -> bool {
        key == &token_extensions_metadata_id()
    }
