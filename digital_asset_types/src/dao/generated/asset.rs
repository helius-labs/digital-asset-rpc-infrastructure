...
impl ColumnTrait for Column {
    ...
    fn def(&self) -> ColumnDef {
        match self {
            Self::Id => ColumnType::Binary(BlobSize::Blob(None)).def(),
            Self::AltId => ColumnType::Binary(BlobSize::Blob(None)).def().null(),
            Self::SpecificationVersion => SpecificationVersions::db_type().def(),
            Self::SpecificationAssetClass => SpecificationAssetClass::db_type().def(),
            Self::Owner => ColumnType::Binary(BlobSize::Blob(None)).def().null(),
            Self::OwnerType => OwnerType::db_type().def(),
            Self::Delegate => ColumnType::Binary(BlobSize::Blob(None)).def().null(),
            Self::Frozen => ColumnType::Boolean.def(),
            Self::Supply => ColumnType::BigInteger.def(),
            Self::SupplyMint => ColumnType::Binary(BlobSize::Blob(None)).def().null(),
            Self::Compressed => ColumnType::Boolean.def(),
            Self::Compressible => ColumnType::Boolean.def(),
            Self::Seq => ColumnType::BigInteger.def(),
            Self::TreeId => ColumnType::Binary(BlobSize::Blob(None)).def().null(),
            Self::Leaf => ColumnType::Binary(BlobSize::Blob(None)).def().null(),
            Self::Nonce => ColumnType::BigInteger.def(),
            Self::RoyaltyTargetType => RoyaltyTargetType::db_type().def(),
            Self::RoyaltyTarget => ColumnType::Binary(BlobSize::Blob(None)).def().null(),
            Self::RoyaltyAmount => ColumnType::Integer.def(),
            Self::AssetData => ColumnType::Binary(BlobSize::Blob(None)).def().null(),
